# PCRLv2 (TPAMI'23)
This repository contains an official implementation of PCRLv2 (<span style="color:red;">Codes of Pre-training and Fine-tuning were included!</span>). The accompanying paper "[A Unified Visual Information Preservation Framework for Self-supervised Pre-training in Medical Image Analysis](https://arxiv.org/pdf/2301.00772.pdf)" has been accepted by IEEE TPAMI. 
